...
<div class="card">
    <div class="card-body">
        <h3>Color Listing  
            ...
            <button class="btn btn-primary btn-sm float-right" v-on:click="addColorModal()">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="colorModalLabel" v-if="editMode">Edit Color</h5>
                            <h5 class="modal-title" id="colorModalLabel" v-else >Add Color</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <form @submit.prevent="editMode ? editColor() : createColor()" @keydown="form.onKeydown($event)">
                            <div class="modal-body">
                                <alert-error :form="form"></alert-error>
                                <div class="form-group">
                                    <label for="name" class="col-md-3">Title</label>
                                    <input v-model="form.name" type="text" name="name" id="tname"
                                    class="form-control" :class="{ 'is-invalid': form.errors.has('name') }" placeholder="Source Title">
    ...
    export default {
        ...
        methods: {
            ...
            createColor() {
                ...
                this.showLoader();
                this.form.post('admin/store-color')
                .then(({ data }) => { 
                    //this.getSources();
                    Toast.fire({ icon: 'success', name: 'Color added successfully' });
            ...
            editSource(event) {
                ...
                .then(({ data }) => { 
                    this.getSources();
                    Toast.fire({ icon: 'success', name: 'Source updated successfully' });
